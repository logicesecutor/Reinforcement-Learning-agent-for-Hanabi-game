...
if __name__ == "__main__":
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sck_client:

        # Create the 
        connection_request = GameData.ClientPlayerAddData(playerName)
        sck_client.connect((HOST, PORT))
        sck_client.send(connection_request.serialize())
